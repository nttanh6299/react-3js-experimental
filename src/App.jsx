...
function Model(props) {
  const { scene, nodes, materials } = useGLTF('/models/weapon_rif_m4a1_silencer.glb');
  const texture = useTexture('/textures/9aa1202db3679dbdc8641639b580423d_component1_texture1.png');
  const ref = useRef();
...
function CameraControls() {
  ...
  const { cameraPosition, cameraRotation } = useControls({
    cameraPosition: { value: [1.5, 0, 0], min: -10, max: 10, step: 0.1 },
  });
